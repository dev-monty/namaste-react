...
const Header = ()=>{
  ...
  <div className="header">
        <img className="logo" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaZFnSHBIx26A5ts74LS2Q_L3xpbklCUEBfg&usqp=CAU" />
...
const RestaurantCard = (props)=>{
  ...
  return(
    ...
    <img src={
      "https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" + props.resData.data.cloudinaryImageId}/>
